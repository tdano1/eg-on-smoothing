...
def sample_noise(model: torch.nn.Module, x: torch.tensor, dist: Distribution, label: int, num: int, num_classes: int, batch_size: int) -> np.ndarray:
...
if __name__ == '__main__':
    def lower_confidence_bound(NA: int, N: int, alpha: float) -> float:
        return proportion_confint(NA, N, alpha=2 * alpha, method="beta")[0]
    # print(confidence_bound(40, 200, 0.1))
    print(lower_confidence_bound(100, 100, 0.001))